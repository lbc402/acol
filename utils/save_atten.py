...
class SAVE_ATTEN(object):
    ...
    def get_masked_img(self, img_path, atten, gt_label,
                       size=(256,256), score_vec=None, maps_in_dir=False, save_dir=None, only_map=False):
